 ...
 */
class Version20151123154518 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE nroho__User DROP INDEX IDX_2DCDD4533594A24E, ADD UNIQUE INDEX UNIQ_2DCDD4533594A24E (permis_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE nroho__User DROP INDEX UNIQ_2DCDD4533594A24E, ADD INDEX IDX_2DCDD4533594A24E (permis_id)');
    }
}
